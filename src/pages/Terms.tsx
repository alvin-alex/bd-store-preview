    ...
    <div className="min-h-screen bg-theme-bg font-manrope">
      <div className="max-w-4xl mx-auto px-8 py-16">
        ...
        <div className="bg-theme-surface rounded-lg shadow-card dark:shadow-card-dark p-8 border border-theme-border">
          <h1 className="text-h2 font-bold text-theme-text mb-8 font-cabinet">Terms of Service</h1>
          
          <div className="prose max-w-none">
            <div className="space-y-8 text-theme-text">
              <section>
                <h2 className="text-h4 font-bold text-theme-text mb-4 font-cabinet">1. Agreement to Terms</h2>
              ...
              <section>
                <h2 className="text-h4 font-bold text-theme-text mb-4 font-cabinet">2. Use License</h2>
              ...
              <section>
                <h2 className="text-h4 font-bold text-theme-text mb-4 font-cabinet">3. Service Terms</h2>
                <p className="text-body text-theme-text-secondary font-manrope leading-relaxed">
              ...
              <section>
                <h2 className="text-h4 font-bold text-theme-text mb-4 font-cabinet">4. Payment Terms</h2>
                <p className="text-body text-theme-text-secondary font-manrope leading-relaxed">
              ...
              <section>
                <h2 className="text-h4 font-bold text-theme-text mb-4 font-cabinet">5. Disclaimer</h2>
                <p className="text-body text-theme-text-secondary font-manrope leading-relaxed">
              ...
              <section>
                <h2 className="text-h4 font-bold text-theme-text mb-4 font-cabinet">6. Limitations</h2>
                <p className="text-body text-theme-text-secondary font-manrope leading-relaxed">
              ...
              <section>
                <h2 className="text-h4 font-bold text-theme-text mb-4 font-cabinet">7. Revisions</h2>
                <p className="text-body text-theme-text-secondary font-manrope leading-relaxed">
              ...
              <section>
                <h2 className="text-h4 font-bold text-theme-text mb-4 font-cabinet">8. Contact Information</h2>
                <p className="text-body text-theme-text-secondary font-manrope leading-relaxed">
